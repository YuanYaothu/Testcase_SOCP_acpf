...
% numbus=85;
% n=numbus;
% branch=xlsread('E:\Coding_Matlab\Codes_Phd\Testcase\12-28-30-33-69-85\85\branch-85');
% branch( :,4)=branch(:,4);
% branch(:,4:5)=branch(:,4:5)./(Un^2/Sn);
% numbranch=size(branch,1);
% 
% Load=[[1:n]',zeros(n,1)];
% dL=xlsread('E:\Coding_Matlab\Codes_Phd\Testcase\12-28-30-33-69-85\85\load-85');
% for kk = 1:size(dL)
%    index = find(Load(:,1)==dL(kk,1));
%    Load(index,2)=dL(kk,2);
% end
...
% Qit = Pit*tan(acos(0.7));
% 
% node_u=xlsread('E:\Coding_Matlab\Codes_Phd\Testcase\12-28-30-33-69-85\85\vol-85');
